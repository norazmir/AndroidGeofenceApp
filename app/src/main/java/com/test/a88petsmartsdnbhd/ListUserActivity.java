...
public class ListUserActivity extends RecyclerView.Adapter<ListUserActivity.StaffViewHolder>{
    ...
    public ListUserActivity(Context mContent, List<Staff> staffList) {
    ...
    public void onBindViewHolder(@NonNull final StaffViewHolder holder, final int position) {
        ...
        holder.staffLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("phone number",staff.getPhoneNum());
