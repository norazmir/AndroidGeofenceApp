...
public class StaffPickupAdapter extends RecyclerView.Adapter<StaffPickupAdapter.PickupViewHolder> {

    private Context mContext;
    private List<Pickup> pickupList;

    public StaffPickupAdapter(Context mContext, List<Pickup> pickupList) {
    ...
    public PickupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.staff_pickup_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull PickupViewHolder holder, int position) {
        ...
        holder.pickupLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, StaffUpdatePickupActivity.class);
