...
public class StaffReservePickupFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.staff_fragment_pickup, container, false);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sDatabase = FirebaseDatabase.getInstance().getReference("Pickup");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                mAdapter = new StaffPickupAdapter(getActivity(), mPickupList);
